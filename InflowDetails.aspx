                        ...
                        <asp:GridView runat="server" ID="GVInflow" AutoGenerateColumns="false" CssClass="table ps" OnRowCommand="GVInflow_RowCommand" HeaderStyle-CssClass="text-dark">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Is Verifed">
                                    <ItemTemplate>
                                        <asp:Label runat="server" CssClass='<%# ((Eval("VerifedStatus").ToString()=="Verified")?" text-success ":" text-warning ") + "text-gradient" %>'
                                            Text='<%# (Eval("VerifedStatus").ToString()) %>'></asp:Label>

                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Is Approved">
                                    <ItemTemplate>
                                        <asp:Label runat="server" CssClass='<%# ((Eval("ApprovedStatus").ToString()=="Approved")?" text-success ":"text-warning " ) +"text-gradient "%>'
                                            Text='<%# (Eval("ApprovedStatus").ToString()) %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
